...
export type ActionType  = FirstTaskActionTypeAT | SomeTaskActionTypeAT | changeTaskStatusAT | ChangeTaskTitleAT | addTodoListAT | removeTodoListAT

export const taskReducer = (tasks: TaskStateType, action: ActionType): TaskStateType => {
    switch (action.type) {
        case 'REMOVE-TASK':
            return ({
                ...tasks,
